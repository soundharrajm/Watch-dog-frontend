        ...
        return (
          <div key={key} className="card p-3">
            ...
            <div className="flex items-center gap-2">
              <span className={`text-2xl font-extrabold leading-none ${value != null ? color : 'text-slate-600'}`}>
                {value ?? '—'}
              </span>
              {pulse && value > 0 && (
                <span className={`w-2 h-2 rounded-full animate-pulse-dot ${PULSE_COLOR[color] || 'bg-red-400'}`}
