...
function AlertRow({ alert, onResolve }) {
  ...
  return (
    <div className={`relative border rounded-xl mb-2 overflow-hidden animate-slide-in ${s.bg} ${alert.resolved?'opacity-40':''}`}>
  ...
  return (
    <div>
      <div className="flex items-center gap-2 flex-wrap mb-4">
        ...
        {alerts.length>0 && <button onClick={onClear} className="btn ml-auto border-red-500/25 text-red-400 hover:bg-red-500/10">Clear all</button>}
      </div>
      {alerts.length===0
